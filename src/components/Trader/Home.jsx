...
import { faMoneyBill, faTruckFast, faClipboardCheck, faCube, faBan, faFilterCircleXmark, faArrowUpShortWide, faUser, faWheatAwn, faMessage } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="m-6">
            <div className="flex flex-wrap -mx-6 w-full">
                <div className="w-full px-2 sm:w-1/2 xl:w-1/4">
                    <div className="bg-white z-10 shadow-lg flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100 border border-[#8DD3BB]">
                        ...
                        <div className="mx-5">
                            ...
                            <h4 className="text-xl font-semibold text-green-700">{Number(data?.total1?.money).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</h4>
                ...
                <div className="w-full px-2 sm:w-1/2 xl:w-1/4 mt-6 sm:mt-0">
                    <div className="bg-white z-10 shadow-lg flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100 border border-[#82D9FF]">
                        ...
                        <div className="mx-5">
                            ...
                            <h4 className="text-xl font-semibold text-[#1F8FBF]">{data?.total2?.order}<FontAwesomeIcon icon={faCube} color={'#1F8FBF'} className='ml-2' /></h4>
                            <div className='flex flex-row mt-2'>
                                <FontAwesomeIcon icon={faArrowUpShortWide} color={'green'} className='mr-2' />
                ...
                <div className="w-full px-2 sm:w-1/2 xl:w-1/4 mt-6 xl:mt-0">
                    <div className="bg-white z-10 shadow-lg flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100 border border-[#FFAF82]">
                        ...
                        <div className="mx-5">
                            <div className="text-gray-500">Khối lượng </div>
                            <h4 className="text-xl font-semibold text-[#E16C2A]">{Math.floor(data?.total3?.quantity)} kg</h4>
                            <div className='flex flex-row mt-2'>
                                <FontAwesomeIcon icon={faArrowUpShortWide} color={'green'} className='mr-2' />
                                <h5 className="text-sl text-green-700">{Math.floor(data?.total3?.quantity_now)} kg</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full px-2 sm:w-1/2 xl:w-1/4 mt-6 xl:mt-0">
                    <div className="bg-white z-10 shadow-lg flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100 border border-[#F77676]">
                        <div className="p-3 rounded-full bg-[#CA1616] bg-opacity-75">
                            <div className="h-8 w-8 text-white flex items-center justify-around">
                                <FontAwesomeIcon icon={faMessage} color={'white'} size='2xl' className='h-[20px]' />
                            </div>
                        </div>
                        <div className="mx-5">
                            <div className="text-gray-500">Bình luận</div>
                            <h4 className="text-xl font-semibold text-[#CA1616]">{data?.total4?.review}<FontAwesomeIcon icon={faMessage} color={'#CA1616'} className='ml-2' /></h4>
                            <div className='flex flex-row mt-2'>
                                <FontAwesomeIcon icon={faArrowUpShortWide} color={'green'} className='mr-2' />
                                <h5 className="text-sl text-green-700">{data?.total4?.review_now}<FontAwesomeIcon icon={faMessage} color={'green'} className='ml-2' /></h5>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex flex-wrap -mx-6 w-full mt-12">
                {(data?.order_month) ? (
                    <div className='flex flex-1 flex-col bg-white w-2/3 lg:w-2/3 sm:w-full m-2'>
                ...
                {(data?.order_status) ? (
                    <div className='flex flex-1 flex-col bg-white w-1/3 lg:w-1/3 sm:w-full m-2'>
                        <label className='text-base font-bold mb-12'>Thống kê các đơn hàng</label>
                        <div className="flex justify-center items-center">
