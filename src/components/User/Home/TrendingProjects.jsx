    ...
    return (
        <div className="container mt-8 mx-auto px-4">
            <div className="sm:flex items-center justify-between">
                <h2 style={{ fontFamily: 'Lora, cursive' }} className="text-4xl font-medium font-lora text-[#546869]">Các sản phẩm bán chạy nhất</h2>
            </div>
            <div
