...
const HistoryOrder = ({
    ...
    return (
        <div className="space-y-6 rounded-lg border border-[#E5DCD7] border-[2px] bg-white p-6 shadow-sm">
            <h3 className="text-xl font-semibold text-gray-900">Lịch sử đơn hàng</h3>

            <ol className="relative ms-3 border-s border-gray-200">
                {received_date ? (
                    status === 4 ? (
                        <li className="mb-10 ms-6 text-green-700">
                        ...
                        <li className="mb-10 ms-6 text-violet-700">
                            <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-violet-100 ring-8 ring-white">
                    ...
                    order_cancellation_date ? (
                        <li className="mb-10 ms-6 text-red-800">
                            <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-red-100 ring-8 ring-white">
                        ...
                        <li className="mb-10 ms-6">
                            ...
                            <h4 className="mb-0.5 text-base font-semibold text-gray-900">Dự kiến {formatDateExpected(Date(), 3)}</h4>
                            <p className="text-sm font-normal text-gray-500">Giao hàng</p>
                        </li>
                    )
                )
                }
                ...
                {received_date ? (
                    ...
                    order_cancellation_date ? (
                        ...
                        delivery_date ? (
                            <li className="mb-10 ms-6 text-yellow-800">
                                <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-yellow-100 ring-8 ring-white">
                            ...
                            <li className="mb-10 ms-6">
                                ...
                                <h4 className="mb-0.5 text-base font-semibold text-gray-900">Dự kiến {formatDateExpected(Date(), 3)}</h4>
                                <p className="text-sm font-normal text-gray-500">Vận chuyển</p>
                            </li>
                        )
                    )
                )
                ...
                {delivery_date ? (
                    ...
                    order_cancellation_date ? (
                        ...
                        <li className="mb-10 ms-6 text-[#3F68D2]">
                ...
                <li className="ms-6 text-green-700">
                    <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-green-100 ring-8 ring-white">
                        <FontAwesomeIcon icon={faCheck} color={'green'} className='w-[15px]' />
                    </span>
                    <h4 className="mb-0.5 font-semibold">{created_at}</h4>
