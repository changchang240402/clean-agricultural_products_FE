...
const User = () => {
    const { userToAdmin, updateStatus } = userService();
    ...
    const fetchData = async () => {
        try {
            const data = await userToAdmin.getUserData(filter.currentPage, filter.search, filter.status, filter.sort);
